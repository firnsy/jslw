...
CheckBox.prototype.set_overlay_image = function(i)
{
...
CheckBox.prototype.set_overlay_alignment = function(h, v)
{
...
CheckBox.prototype.set_overlay_alignment_horizontal = function(type)
{
  type = type || 'left';
...
CheckBox.prototype.set_overlay_alignment_vertical = function(type)
{
  type = type || 'top';
...
CheckBox.prototype.overlay_calculate_offset = function()
{
...
CheckBox.prototype.render_widget = function(context)
{
